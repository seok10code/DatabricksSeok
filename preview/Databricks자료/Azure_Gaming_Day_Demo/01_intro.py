...
# MAGIC
# MAGIC echo """{\"username\":\"minjipark\",\"key\":\"566b2961bebef250c4057bd87b405256\"}""" > /root/.kaggle/kaggle.json
# MAGIC
...
# MAGIC %sh
# MAGIC
# MAGIC mkdirs /dbfs/FileStore/tmpdir

# COMMAND ----------

# MAGIC %sh -e
# MAGIC
# MAGIC cd /dbfs/FileStore/tmpdir
...
# MAGIC %sh
# MAGIC
# MAGIC ls /dbfs/FileStore/tmpdir
...
# MAGIC
# MAGIC cd /dbfs/FileStore/tmpdir
# MAGIC kaggle datasets download -d devinanzelmo/dota-2-matches
