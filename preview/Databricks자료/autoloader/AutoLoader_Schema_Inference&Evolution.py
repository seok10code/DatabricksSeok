...
# MAGIC
# MAGIC
# MAGIC - DBR 8.2 이상에서 Autoloader의 Schema Inference 와 Schema Evolution 지원 
# MAGIC - 2021.12현재 JSON, binary,text file 포맷 지원 
# MAGIC - 데모상에서는 "directory listing mode" 를 사용. 
# MAGIC - ["file notification mode" for file discovery](https://docs.databricks.com/spark/latest/structured-streaming/auto-loader.html#file-discovery-modes) 사용시에는 추가 설정 필요 
# MAGIC
...
spark.table(bronzeTableName).count()
