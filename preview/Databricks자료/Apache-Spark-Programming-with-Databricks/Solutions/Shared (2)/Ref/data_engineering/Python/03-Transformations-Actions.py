...
# Option B: A short-hand for Option A (Python Only, not available in Scala)
...
# Option C: Use the col(..) function to reference a named column.
columnC = col("price")
print(columnC)

# Option D: Use the expr(..) function to create a column from an SQL Expression
columnD = expr("price * 2")
print(columnD)
...
display(droppedDF.withColumn("Tax", sparkRound((col("price") * 1.1),2)))
