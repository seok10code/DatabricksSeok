...
val MOUNTPOINT = "/mnt/partnerdata-internal"
...
val mayDF = spark.read.parquet("/mnt/partnerdata-external/internetSales/05/")
...
transformedMayDF.write
  .mode("overwrite")
  .jdbc(JDBC_URL_DATA_WAREHOUSE, "FactInternetSalesStaging", new java.util.Properties())
